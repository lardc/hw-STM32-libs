		...
		volatile Int64U *pTimer, Int16U NodeID)
{
	...
	Interface->IOConfig->IO_ConfigMailbox(Master_MBOX_BP,		MasterFilterID + CAN_ID_R_BP,		0);
	Interface->IOConfig->IO_ConfigMailbox(Master_MBOX_BP_A,		MasterFilterID + CAN_ID_A_BP,		0);
}
// ----------------------------------------
